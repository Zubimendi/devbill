        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          <div className="relative w-full max-w-lg perspective-1000">
            ...
            <div className="absolute -bottom-8 -right-8 glass-panel p-6 rounded-2xl w-64 translate-z-10 border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-white text-sm font-semibold">Ready to scale</span>
              </div>
              <div className="h-2 w-full bg-white/10 rounded-full mb-2">
                <div className="h-full w-full bg-tertiary-custom rounded-full"></div>
              </div>
              <span className="text-white/60 text-xs">Join thousands of developers</span>
            </div>
          </div>
          <div className="mt-24 text-center max-w-sm mx-auto">
            <h1 className="text-5xl lg:text-6xl font-bold text-white tracking-tighter mb-8 leading-[1.1]">
              ...
              <span className="text-primary-fixed-dim italic">Join the ledger.</span>
            </h1>
          </div>
        </div>
      ...
      <main className="flex-1 bg-surface-container-low/30 relative flex flex-col items-center justify-center p-8 md:p-12 overflow-y-auto">
        <div className="w-full max-w-md my-auto space-y-10">
          ...
          <div className="text-center lg:text-left space-y-3">
            <h2 className="text-4xl md:text-5xl font-bold text-on-surface tracking-tighter">Create account</h2>
            <p className="text-on-surface-variant font-medium text-lg leading-relaxed opacity-80">Start managing your developer invoices professionally.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant/70 ml-1" htmlFor="name">Full Name</label>
              <input 
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant/70 ml-1" htmlFor="password">Password</label>
              <input 
                className="w-full px-4 py-3.5 bg-surface-container-lowest rounded-xl border border-outline-variant/15 text-on-surface font-medium focus:ring-2 focus:ring-primary-custom focus:border-transparent transition-all outline-none placeholder:text-outline/40" 
                id="password" 
                name="password"
            ...
            <div className="relative flex items-center py-4">
              ...
              <span className="flex-shrink mx-4 text-on-surface-variant text-[10px] font-bold uppercase tracking-widest leading-none">or sign up with</span>
              <div className="flex-grow border-t border-outline-variant/15"></div>
            </div>
          ...
          <div className="pt-6 border-t border-outline-variant/10 text-center">
            <p className="text-on-surface-variant text-sm font-medium">
              ...
              <Link className="text-primary-custom font-bold hover:underline underline-offset-8 ml-1.5" href="/login">Sign in</Link>
            </p>
          </div>
